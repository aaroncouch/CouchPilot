...
def _print_session_cache_notice() -> None:
    ...
    print("  2. Ask any synced subagent (`/planner-composer`, `/planner-codex`,")
    print("     `/planner-gpt55`, `/python-coder-composer`, `/python-coder-codex`,")
    print("     `/reviewer-composer`, `/reviewer-codex`, `/reviewer-gpt55`)")
