...
- `/audit-test-integrity` audits the diff against `main`.
- `/audit-test-integrity workspace` audits tracked and untracked working files.
- `/audit-test-integrity <paths>` audits the named files or directories.
